          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-0.5 flex items-center gap-2">
              ...
              <div className="flex items-center gap-1">
                ...
                {!isComplete && !failed && (
                  <UploadCloud02 className="stroke-[2.5px text-fg-quaternary size-4" />
                )}
                {!isComplete && !failed && (
                  <p className="text-quaternary text-sm font-medium">Uploading...</p>
                )}
...
export const FileListItemProgressFill = ({
  ...
  return (
    <motion.li
      layout="position"
      className={cx('bg-primary relative flex gap-3 overflow-hidden rounded-xl p-4', className)}
    >
      {/* Progress fill. */}
      <div
